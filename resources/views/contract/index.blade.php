<x-app-layout title="Import Contract">
    @push('styles')
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="col-12 text-justify">
                    The correct column order is (NO PKWT, STATUS, NIK, NAME, ADDRESS, NO KTP, Position, Contrack length, marital status and etc.)
                </p>
                <div class="timeline timeline-sm">
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-item-content">NO PKWT must be filled</div>
                    </div>
