      ...
      <div class="page-header-content">
        <div class="row align-items-center justify-content-between pt-3">
          ...
          <div class="col-12 col-xl-auto mb-3">
            <a class="btn btn-sm btn-light text-blue" href="/kompensasi-dan-keuntungan/lembur">
                  ...
                  <tr>
                    <td>
                      ...
                      <div class="text-center">
                        <img src="{{ asset('assets/img/backgrounds/logo-disetujui.png') }}" style="height: 80px;" alt="">
                      </div>
                      @endif
                    </td>
                    <td>
                      @if($data->persetujuan_hod == 'Diterima')
                      <div class="text-center">
                        <img src="{{ asset('assets/img/backgrounds/logo-disetujui.png') }}" style="height: 80px;" alt="">
                      </div>
                      @endif
        ...
        <div class="card mb-4 mb-xl-0">
          ...
          <div class="card-body">
            <form action="{{ route('update.lembur', $data->id) }}" method="post" enctype="multipart/form-data">
              @csrf
              {{ method_field('patch') }}
              <label for="Status pengajuan" class="mb-2">Pilih status</label>
              <select name="persetujuan_hod" class="form-select">
