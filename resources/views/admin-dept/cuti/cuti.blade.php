<x-app-layout title="Cuti Tahunan">
            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        <a class="btn btn-sm btn-light text-blue" href="/admin/cuti">
    ...
    <div class="container-xl px-4 mt-4">
        <nav class="nav nav-borders">
            <a class="nav-link {{ (request()->segment(3) == 'tahunan') ? 'active' : '' }} ms-0" href="/admin/cuti/tahunan">Cuti</a>
            <a class="nav-link {{ (request()->segment(3) == 'paidleave') ? 'active' : '' }} ms-0" href="/admin/cuti/paidleave">Izin berbayar</a>
            <a class="nav-link {{ (request()->segment(3) == '') ? 'active' : '' }} ms-0" href="/admin/cuti/unpaidleave">Izin tidak berbayar</a>
        </nav>
        <hr class="mt-0 mb-4">
            ...
            <div class="card-body">
                <div class="row justify-content-center">
                    <div class="col-xxl-6 col-xl-8">
                        ...
                        <form action="/admin/cuti/tahunan/store" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="row gx-3 mb-2">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input name="sisa_cuti" class="form-control" type="text" id="sisa_cuti" readonly />
                                </div>
                            </div>
                            <hr class="my-4" />
                            <div class="d-grid">
