<x-app-layout title="Karyawan">
  ...
  <div class="container-fluid px-4">
    <nav class="nav nav-borders">
      ...
      <a class="nav-link {{ (request()->segment(2) == 'monthly') ? 'active' : '' }} ms-0" href="/employees/monthly">Bulanan</a>
          ...
          <div class="card-body" style="overflow-x:auto;">
            <div class="row gx-3 mb-3">
              <div class="col-md-6 mb-2">
                <label class="small mb-1">Pilih periode masuk</label>
  ...
  <script>
    $(function() {
      ...
      var table = $('#data-table-karyawan').DataTable({
        ...
        ajax: {
          url: "/api/hrcorner/employees/monthly",
          data: function(d) {
