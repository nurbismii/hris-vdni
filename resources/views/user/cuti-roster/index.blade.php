      ...
      <div class="card-body">
        <div class="row justify-content-center">
          <div class="col-xxl-6 col-xl-8">
            ...
            <form id="form-cuti" action="{{ route('store.cuti-roster') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <!-- <div class="mb-3">
            ...
            <form id="form-kerja" action="{{ route('store.cuti-roster') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="row gx-3 mb-2">
