            ...
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        ...
                        <div class="page-header-subtitle">Izin yang dibayarkan akan setujui jika melengkapi syarat dan ketentuan yang berlaku.</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row justify-content-center">
                    <div class="col-xxl-6 col-xl-8">
                        ...
                        <form action="/pengajuan/store-izin-dibayarkan" method="POST" enctype="multipart/form-data">
                            @csrf
