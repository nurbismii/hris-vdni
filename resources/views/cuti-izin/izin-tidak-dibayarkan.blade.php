                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        <h1 class="page-header-title">
                            ...
                            Izin Tidak Dibayarkan
                        </h1>
                        <div class="page-header-subtitle">Izin yang tidak dibayarkan</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row justify-content-center">
                    <div class="col-xxl-6 col-xl-8">
                        ...
                        <form action="/pengajuan/store-izin-tidak-dibayarkan" method="POST" enctype="multipart/form-data">
                            @csrf
