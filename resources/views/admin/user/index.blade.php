                ...
                <table id="datatablesSimple">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('users.destroy', $row->nik_karyawan) }}" method="POST">
                                    @csrf
                                    {{ method_field('delete') }}
                                    <a class="btn btn-datatable btn-icon btn-transparent-dark me-2" href="{{ route('users.edit', $row->nik_karyawan) }}"><i data-feather="edit"></i></a>
    ...
    <div class="modal fade" id="deleteUser{{$data->nik_karyawan}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('users.destroy', $data->nik_karyawan) }}" method="POST" enctype="application/x-www-form-urlencoded" class="nav flex-column" id="stickyNav">
