<x-app-layout title="Karyawan">
  ...
  <div class="container-fluid px-4">
    <nav class="nav nav-borders">
      <a class="nav-link ms-0" href="/employees">Keseluruhan</a>
      <a class="nav-link ms-0" href="/employees/monthly">Bulanan</a>
      <a class="nav-link {{ (request()->segment(2) == 'weekly') ? 'active' : '' }} ms-0" href="/employees/weekly">Mingguan</a>
    </nav>
    <hr class="mt-0 mb-4" />
    <div class="row">
      <div class="col-lg-12">
          ...
          <div class="card-body" style="overflow-x:auto;">
            <div class="row gx-3 mb-3">
              <div class="col-md-6 mb-2">
                <label class="small mb-1">Rentang tanggal masuk</label>
              ...
              <div class="col-md-3 mb-2">
                <a class="btn btn-light text-primary mt-2" href="/employees">
                  <i class="me-1" data-feather="trash"></i>
                  Hapus filter
                </a>
              </div>
