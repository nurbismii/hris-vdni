    ...
    <div class="container-fluid px-4">
        <div class="row">
            <div class="col-lg-12 mb-3">
                ...
                <div class="card">
                    <div class="col-lg">
                        <form action="{{ route('periode-roster.store') }}" method="POST" class="nav flex-column" id="stickyNav">
                            @csrf
    ...
    <div class="modal fade" id="editPeriode{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('periode-roster.update', $data->id) }}" method="POST" class="nav flex-column" id="stickyNav">
                    @csrf
                    {{ method_field('patch') }}
                    <div class="modal-body">
                        <div class="mb-3">
    ...
    <div class="modal fade" id="delPeriode{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('periode-roster.destroy', $data->id) }}" method="POST" class="nav flex-column" id="stickyNav">
                    <div class="modal-body">
                        @csrf
                        {{ method_field('delete') }}
