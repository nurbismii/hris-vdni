			...
			<div class="container-xl px-1">
				...
				<table style="width: 100%;">
					<tr>
						<td style="width: 3%;"></td>
						<td style="width: 3%;">-</td>
						<td style="width: 12%;">Uang pesangon</td>
						<td style="width: 15%;">({{ $data->bil_severance }} x {{$data->service_year}} x {{ $data->net_salary }},-)</td>
						<td style="width: 3%;">:</td>
					...
					<tr>
						<td style="width: 3%;"></td>
						<td style="width: 3%;">-</td>
						<td style="width: 12%;">Uang penghargaan</td>
						<td style="width: 15%;">{{$data->bil_award}} x {{$data->net_salary}}</td>
						<td style="width: 3%;">:</td>
						<td style="width: 10%;">{{$data->subtotal_award}}</td>
					</tr>
					<tr>
						<td style="width: 3%;"></td>
						<td style="width: 3%;">-</td>
