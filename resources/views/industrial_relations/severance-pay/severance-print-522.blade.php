			...
			<div class="container-xl px-1">
				...
				<table style="width: 100%;">
					<tr>
						<td style="width: 3%;"></td>
						<td style="width: 3%;">-</td>
						<td style="width: 12%;">Uang pisah</td>
						<td style="width: 15%;">({{ $data->bil_severance }} x {{ $data->net_salary }},-)</td>
						<td style="width: 3%;">:</td>
						<td style="width: 10%;">{{ $data->subtotal_severance }}</td>
					</tr>
					<tr>
						<td style="width: 3%;"></td>
						<td style="width: 3%;">-</td>
						<td style="width: 12%;">Penggantian Hak</td>
					...
					<tr>
						<td style="width: 3%;"></td>
						<td style="width: 3%;"></td>
						<td style="width: 12%;">a. Cuti Tahunan</td>
						<td style="width: 15%;">({{ $data->remaining_leave }} x {{ $data->net_salary }},-) : {{ $data->bil_annual }}</td>
						<td style="width: 3%;">:</td>
						<td style="width: 10%;">{{$data->subtotal_annual}}</td>
					</tr>
					<tr>
						<td style="width: 3%;"></td>
						<td style="width: 3%;"></td>
						<td style="width: 12%;">b. Ongkos pulang</td>
						<td style="width: 15%;"></td>
						<td style="width: 3%;">:</td>
						<td style="width: 10%;">{{$data->return_cost}}</td>
					</tr>
					<tr>
						<td style="width: 3%;"></td>
						<td style="width: 3%;"></td>
				...
				<table style="width: 100%;">
					<tr>
						<td style="width: 8%"></td>
						<td class="align-top" style="width: 5%">4.</td>
						<td>
					...
					<tr>
						<td style="width: 6"></td>
						<td class="align-top" style="width: 5%">5.</td>
						<td class="justify">
					...
					<tr>
						<td style="width: 6"></td>
						<td class="align-top" style="width: 5%">6.</td>
						<td class="justify">
					...
					<tr>
						<td style="width: 6"></td>
						<td class="align-top" style="width: 5%">7.</td>
						<td class="justify">
					...
					<tr>
						<td style="width: 6"></td>
						<td class="align-top" style="width: 5%">8.</td>
						<td class="justify">
