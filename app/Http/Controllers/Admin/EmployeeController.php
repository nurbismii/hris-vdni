...
class EmployeeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.employee.index', compact('depts', 'provinsi'));
    }
    ...
    public function edit($nik)
    {
        try {
            ...
            return view('admin.employee.edit', compact('data', 'mutasi', 'level_vaksin', 'data_resign'));
        } catch (\Throwable $e) {
    ...
    public function importEmployee(Request $request)
    {
        try {
            ...
            return back()->with('error', 'Terjadi kesalahan pada proses import');
        }
    }
