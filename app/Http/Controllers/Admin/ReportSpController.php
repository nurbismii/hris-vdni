...
class ReportSpController extends Controller
{
    ...
    {
        return view('admin.industrial_relations.report-sp.index');
    }
    ...
    public function serverSidePeringatan(Request $request)
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return view('admin.industrial_relations.report-sp._action', [
                    'data' => $data,
                    'url_detail' => route('spreport.edit', $data->id),
                ]);
    ...
    public function edit($id)
    {
        ...
        return view('admin.industrial_relations.report-sp.edit', compact('data'));
    }
    ...
    {
        return view('admin.industrial_relations.report-sp.import');
    }
}
